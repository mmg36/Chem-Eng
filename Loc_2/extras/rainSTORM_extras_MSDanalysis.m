...
tFrame = 0.040;         % E.g. 40 ms Cycle time
...
handleLine1 = plot( (1:longestTrack)*tFrame, avMsds, 'b--','LineWidth',2);

hold off

xlabel('Time / s', 'fontsize',18)
ylabel('MSD  / \mu{}m^2 ', 'fontsize',18)
title('Evaluated Mean Squared Displacements', 'fontsize',18)
legend(handleLine1,'Average')

set(gca,'FontSize',18,'fontweight','bold');
set(myPlot3,'Position',[100,100,720,600]); % 720 px wide, 600 high
set(myPlot3,'color','w')
