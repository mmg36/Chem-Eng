...
% function [] = rainSTORM_recon_JH(reviewedPosits,reviewedParams,reviewedDeltaX)
function params = rainSTORM_recon_JH(params)
...
if(flagPlotJH)
    params = rainSTORM_display(params, jhImage, jhLinMag);
end
...
params.flags.CalculatedJH=flagCalculatedJH;
params.reviewer.results.jhImage = jhImage;
params.reviewer.results.jhParams = jhParams;
params.reviewer.results.jhLinMag = jhLinMag;
end